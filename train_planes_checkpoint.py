...
# networks
policy_net = torch.load("plane_models/target_net_249.pt").to(device)
...
total_time = 0
for i_epoch in range(250, NUM_EPOCHS):
    ...
    torch.save(target_net, "plane_models/target_net_{}.pt".format(i_epoch))
